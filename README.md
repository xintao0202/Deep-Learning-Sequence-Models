...
2.1 Embedding Vector
 ...
 - E * O1234 wind up to be selecting out this 300-dimensional column correspoinding to the word in embedding matrix: E * Oj=ej
 ...
 - Since Oj (one hot vectors) has all element zero except for position j, we actually use a specialized function to just look up a column to Matrix E rather than do the matrix multiplication
